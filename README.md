# lmdb-go [![releases/v1.9.2](https://img.shields.io/badge/release-v1.9.3-375eab.svg)](https://github.com/sxwebdev/lmdb-go/releases) [![C/v0.9.33](https://img.shields.io/badge/C-v0.9.33-555555.svg)](https://github.com/LMDB/lmdb/blob/mdb.RE/0.9/libraries/liblmdb/CHANGES) [![Build Status](https://github.com/sxwebdev/lmdb-go/actions/workflows/go.yml/badge.svg?branch=master)]
...
_bmatsuo_ for creating and maintaining this repository until 2017.
...
`github.com/bmatsuo/lmdb-go` to `github.com/sxwebdev/lmdb-go`.
...
#### lmdb [![GoDoc](https://godoc.org/github.com/sxwebdev/lmdb-go/lmdb?status.svg)](https://godoc.org/github.com/sxwebdev/lmdb-go/lmdb) [![stable](https://img.shields.io/badge/stability-stable-brightgreen.svg)](#user-content-versioning-and-stability)

```go
import "github.com/sxwebdev/lmdb-go/lmdb"
```

Core bindings allowing low-level access to LMDB.

#### lmdbscan [![GoDoc](https://godoc.org/github.com/sxwebdev/lmdb-go/lmdbscan?status.svg)](https://godoc.org/github.com/sxwebdev/lmdb-go/lmdbscan) [![stable](https://img.shields.io/badge/stability-stable-brightgreen.svg)](#user-content-versioning-and-stability)

```go
import "github.com/sxwebdev/lmdb-go/lmdbscan"
```
...
#### exp/lmdbsync [![GoDoc](https://godoc.org/github.com/sxwebdev/lmdb-go/exp/lmdbsync?status.svg)](https://godoc.org/github.com/sxwebdev/lmdb-go/exp/lmdbsync) [![experimental](https://img.shields.io/badge/stability-experimental-red.svg)](#user-content-versioning-and-stability)

```go
import "github.com/sxwebdev/lmdb-go/exp/lmdbsync"
```
...
[documentation](https://godoc.org/github.com/sxwebdev/lmdb-go/lmdb) so they are
...
[documentation](https://godoc.org/github.com/sxwebdev/lmdb-go/exp/lmdbsync) for
...
[issue](https://github.com/sxwebdev/lmdb-go/issues/1).
...
of lmdb. In addition to [godoc](https://godoc.org/github.com/sxwebdev/lmdb-go)
...
- Its simpler design and implementation in pure Go mean it is free of many
  ...
  [documentation](https://godoc.org/github.com/sxwebdev/lmdb-go/lmdb).
...
`go get github.com/sxwebdev/lmdb-go/lmdb`
...
[godoc.org](https://godoc.org/github.com/sxwebdev/lmdb-go) is the primary source
